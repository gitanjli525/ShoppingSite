...
import TableHeader from 'src/views/pages/customers/TableHeader'
import SidebarAddUser from 'src/views/pages/customers/AddUserDrawer'
import EcommerceSalesOverview from 'src/views/pages/customers/EcommerceSalesOverview'
...
const UserList = () => {
  ...
  return (
    ...
    <EcommerceSalesOverview></EcommerceSalesOverview>
